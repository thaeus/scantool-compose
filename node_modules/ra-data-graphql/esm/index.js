...
export default (function (options) { return __awaiter(_this, void 0, void 0, function () {
            ...
            case 2:
                ...
                raDataProvider = function (aorFetchType, resource, params) {
                    ...
                    var _a = overriddenBuildQuery
                        ? __assign({}, buildQuery(aorFetchType, resource, params), overriddenBuildQuery(params)) : buildQuery(aorFetchType, resource, params), parseResponse = _a.parseResponse, query = __rest(_a, ["parseResponse"]);
                    if (QUERY_TYPES.includes(aorFetchType)) {
                        var apolloQuery_1 = __assign({}, query, { fetchPolicy: 'network-only' }, getOptions(otherOptions.query, aorFetchType, resource));
